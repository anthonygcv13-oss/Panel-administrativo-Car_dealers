...
import { Eye, EyeOff, AlertCircle, CheckCircle, Sun, Moon, ArrowLeft } from 'lucide-react'
...
export default function ResetPasswordPage() {
  ...
  const inputClass = `border-2 transition-all duration-300 ${
    isDark
          ...
          <CardContent className="pt-8 pb-8">
            {success ? (
              <div className="text-center space-y-6">
                ...
                <Button
                  onClick={() => router.push('/')}
                  className="bg-gradient-to-r from-luxe-gold to-soft-gold hover:from-soft-gold hover:to-luxe-gold text-white font-bold transition-all duration-300 shadow-lg hover:shadow-xl"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                {!token ? (
                  ...
                  >
                    ...
                    <span className="text-sm text-accent-rouge/80">
                      Enlace inválido.{' '}
